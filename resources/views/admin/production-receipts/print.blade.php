...
<head>
    <meta charset="utf-8">
    <title>{{ $productionReceipt->receipt_no }}</title>
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .stage { text-align: center; font-size: 23px; font-weight: 700; font-style: italic; margin: 22px 0 8px; }
...
<body>
    ...
    @for ($copy = 1; $copy <= 2; $copy++)
        <section class="copy">
            ...
            <div class="stage">Công đoạn sx: {{ $productionReceipt->cong_doan }}</div>
            ...
            <div class="date">
                NGÀY&nbsp;&nbsp;{{ $productionReceipt->receipt_date->format('d') }}
                &nbsp;THÁNG&nbsp;&nbsp;{{ $productionReceipt->receipt_date->format('m') }}
                &nbsp;NĂM&nbsp;{{ $productionReceipt->receipt_date->format('Y') }}
            </div>
